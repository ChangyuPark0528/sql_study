...
-- length(길이) instr(문자찾기, 없으면 0을 반환, 있으면 인덱스값)
...
-- REPLACE()
SELECT 
    REPLACE('My dream is a president', 'president', 'porgrammer')
FROM dual;
...
전화 번호를 출력하도록 쿼리를 작성하세요. (CONCAT(붙이기), SUBSTR(문자열자르기) 사용)
*/
