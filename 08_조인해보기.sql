...
*/
 ...
 -- employees 테이블의 부서 id와 일치하는 departments 테이블의 부서id를
 -- 찾아 SELECT 이하에 있는 컬럼들을 출력하는 쿼리문.
SELECT
    e.first_name,
    d.department_name
...
SELECT
    ...
    e.salary, e.job_id, d.department_id
FROM employees e INNER JOIN departments d
ON e.department_id = d.department_id; -- ANSI 표준 조인문법
