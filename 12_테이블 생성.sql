...
CREATE TABLE dept2(
    dept_no NUMBER(2),
    dept_name VARCHAR2(14), -- 영어는 1 byte 한글은 3byte
    loca VARCHAR2(15),
    dept_date DATE,
...
INSERT INTO dept2
VALUES(10, '개발부', '서울', sysdate, 100000);

INSERT INTO dept2
VALUES(20, '영업부', '서울', sysdate, 200000);

-- NUMBER와 VARCHAR2 타입의 길이를 확인.
INSERT INTO dept2
VALUES(30, '경영지원', '경기', sysdate, 200000);
...
-- 열 속성 수정
-- 만약 변경 하고자 하는 컬럼에 데이터가 이미 존재한다면 그에 맞는 타입으로
